INSERT INTO `activities` (`id`, `name`, `content`, `image`) VALUES (1, 'Programas Educativos', 'Mediante nuestros programas educativos, buscamos incrementar la capacidad intelectual, moral y afectiva de las personas de acuerdo con la cultura y las normas de convivencia de la sociedad a la que
pertenecen.', 'Foto 1.jpg');

INSERT INTO `activities` (`id`, `name`, `content`, `image`) VALUES (2, 'Apoyo Escolar para el nivel Primario', 'El espacio de apoyo escolar es el corazón del área educativa. Se realizan los
...
INSERT INTO `activities` (`id`, `name`, `content`, `image`)VALUES (3, 'Apoyo Escolar Nivel Secundaria', 'Del mismo modo que en primaria, este taller es el corazón del área
...
INSERT INTO `activities` (`id`, `name`, `content`, `image`) VALUES (4, 'Tutorías', 'Es un programa destinado a jóvenes a partir del tercer año de secundaria,
